...
SELECT SNAME FROM STUDENTS WHERE NGROUP = 'AnasBinMalek';
...
SELECT SNAME ,STUDENTS.STUDNO, TO_CHAR(TODAY_IS_DATE, 'DD/MM/YYYY')  STUD_DATE,PAGESNUM "عدد_صفحات_مسمعة", LVL "تقدير", HOMEWORK "وظيفة" , NOTES "ملاحظات" FROM STUDENTS ,SCHECK WHERE STUDENTS.STUDNO = SCHECK.STUDNO
SELECT SNAME,عدد_صفحات_مسمعة, تقدير,وظيفة, ملاحظات FROM VIEW_CHECK_STUDENT WHERE  STUD_DATE = '05/06/2022'
