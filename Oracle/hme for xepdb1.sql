...
SELECT SUBSTR(FLUNIVCNTY,1,INSTR(FLUNIVCNTY,'(',1,1) - 1) FROM UNIV_WITH_COUNTRY
...
SELECT SUBSTR(VACANCY_NAME,1,INSTR(VACANCY_NAME,'(',1,1) - 1) FROM VAC_COND_VIEW
SELECT * FROM VACANCY
DROP TABLE DELETENUM
...
DESC STUDENTS
SELECT * FROM VACANCY
DELETE FROM VACANCY WHERE ID_VACANCY = 8
SELECT * FROM EMP_CONDITION
DESC EMAILPHONE
SELECT * FROM GRADUATE
DESC GRADUATE
UPDATE GRADUATE SET GRADUATE_CHECK = 0
UPDATE GRADUATE SET GRADUATE_DATE = '2001-06-25'
SELECT * FROM GRADUATE 
INSERT INTO EMAILPHONE VALUES(NULL, 'king86375hp@gmail.com', 1, NULL, NULL, '0936968795', '=@C>AD?BE=@C>AD?BE');
SELECT * FROM COUNTRY
SELECT * FROM VACANCY
SELECT * FROM MINISTRY
SELECT  ID_VACANCY, '(' || VACANCY_TYPE || ') ' || MINISTRY_NAME AS FULLNAME FROM MINISTRY M, VACANCY V WHERE M.ID_MINISTRY = V.ID_MINISTRY AND VACANCY_AVG <= 50 AND VACANCY_NAME = 'هندسة معلوماتية'
SELECT  V.ID_VACANCY, MINISTRY_NAME || ' (' || VACANCY_TYPE || ') مع شرط ('||  NVL(EMP_CONDITION_NAME, 'لا يوجد شرط') || ') ونوعه (' ||  NVL(EMP_CONDITION_TYPE, 'لا يوجد نوع الشرط') || ')'  AS FULLNAME FROM MINISTRY M, VACANCY V, EMP_CONDITION E WHERE M.ID_MINISTRY = V.ID_MINISTRY AND V.ID_VACANCY = E.ID_VACANCY(+)
SELECT  V.ID_VACANCY, MINISTRY_NAME || ' (' || VACANCY_TYPE || ') مع شرط ('||  NVL(EMP_CONDITION_NAME, 'لا يوجد شرط') || ') ونوعه (' ||  NVL(EMP_CONDITION_TYPE, 'لا يوجد نوع الشرط') || ')'  AS FULLNAME FROM MINISTRY M, VACANCY V, EMP_CONDITION E WHERE M.ID_MINISTRY = V.ID_MINISTRY AND V.ID_VACANCY = E.ID_VACANCY(+) AND VACANCY_AVG <= 50 AND VACANCY_NAME = 'هندسة معلوماتية' ORDER BY 2
DESC MINISTRY
DESC VACANCY
DESC EMP_CONDITION
SELECT * FROM GRADUATE, EMAILPHONE WHERE ID_GRADUATE = ID_G
BEGIN
DELETE FROM EMAILPHONE WHERE ID_G = 3;
DELETE FROM GRADUATE WHERE ID_GRADUATE = 3;
END;
SELECT ID_GRADUATE FROM GRADUATE WHERE GRADUATE_ID_NUMBER = 2222222
BEGIN
INSERT INTO DESIRE VALUES(NULL, 1, 1, 1);
INSERT INTO DESIRE VALUES(NULL, 1, 2, 2);
INSERT INTO DESIRE VALUES(NULL, 1, 3, 3);
INSERT INTO DESIRE VALUES(NULL, 1, 4, 4);
INSERT INTO DESIRE VALUES(NULL, 1, 5, 5);
INSERT INTO DESIRE VALUES(NULL, 1, 6, 6);
END;
SELECT * FROM DESIRE
DELETE FROM DESIRE
SELECT SNAME FROM STUDENTS WHERE NGROUP = 'AnasBinMalek' ORDER BY 1
UPDATE EMP_CONDITION SET RESULT_CONDITION = WHERE ID_VACANCY = AND EMP_CONDITION_TYPE = ;
SELECT * FROM VACANCY
SELECT * FROM EMP_CONDITION
SELECT * FROM MINISTRY
UPDATE EMP_CONDITION SET RESULT_CONDITION = 0 WHERE ID_EMP_CONDITION = 3;
UPDATE GRADUATE SET GRADUATE_AVG = 74 WHERE ID_GRADUATE = 2
SELECT * FROM GRADUATE ORDER BY GRADUATE_AVG DESC, GRADUATE_SHAHID DESC
DESC GRADUATE
DESC DESIRE
DESC RESULT
SELECT * FROM VACANCY
CREATE VIEW VIEW_ALL_DESIRE AS
SELECT  V.ID_VACANCY || '|' || ID_EMP_CONDITION FULLID, MINISTRY_NAME || ' (' || VACANCY_TYPE || ') مع شرط ('||  NVL(EMP_CONDITION_NAME, 'لا يوجد شرط') || ') ونوعه (' ||  NVL(EMP_CONDITION_TYPE, 'لا يوجد نوع الشرط') || ')'  AS FULLNAME, V.* FROM MINISTRY M, VACANCY V, EMP_CONDITION E WHERE M.ID_MINISTRY = V.ID_MINISTRY AND V.ID_VACANCY = E.ID_VACANCY(+)
SELECT * FROM VIEW_ALL_DESIRE
SELECT FULLNAME FROM VIEW_ALL_DESIRE WHERE ID_MINISTRY IN (SELECT ID_MINISTRY FROM RESULT WHERE ID_GRADUATE = 1) AND ID_VACANCY IN (SELECT ID_VACANCY FROM DESIRE WHERE ID_GRADUATE = 1)
SELECT * FROM MINISTRY
INSERT INTO RESULT VALUES(NULL, 1, 3)
SELECT * FROM RESULT
DELETE FROM RESULT
select * from GRADUATE
SELECT * FROM EMP_CONDITION
SELECT NVL(ID_MINISTRY, '444'), NVL(MINISTRY_NAME, '444') AS MINI_NAME FROM MINISTRY WHERE ID_MINISTRY IN (SELECT ID_MINISTRY FROM RESULT WHERE ID_GRADUATE = 1)