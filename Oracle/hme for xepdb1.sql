...
SELECT * FROM VACANCY
SELECT * FROM MINISTRY
SELECT  ID_VACANCY, '(' || VACANCY_TYPE || ') ' || MINISTRY_NAME AS FULLNAME FROM MINISTRY M, VACANCY V WHERE M.ID_MINISTRY = V.ID_VACANCY AND VACANCY_AVG <= 50 AND VACANCY_NAME = 'هندسة معلوماتية'
