...
SELECT ID_VACANCY, VACANCY_NAME || ' (' || VACANCY_TYPE || ') ' FULLVAC FROM VACANCY WHERE ID_VACANCY NOT IN (SELECT ID_VACANCY FROM EMP_CONDITION WHERE EMP_CONDITION_TYPE = 'Textual') 
AND ID_VACANCY NOT IN (SELECT ID_VACANCY FROM EMP_CONDITION WHERE EMP_CONDITION_TYPE = 'Digital') AND
ID_VACANCY NOT IN (SELECT ID_VACANCY FROM EMP_CONDITION WHERE EMP_CONDITION_TYPE = 'Logical') AND 
ID_VACANCY NOT IN (SELECT ID_VACANCY FROM EMP_CONDITION WHERE EMP_CONDITION_TYPE = 'MultipleChoice') AND ID_MINISTRY = 1

SELECT ID_VACANCY, VACANCY_NAME || ' (' || VACANCY_TYPE || ') ' FULLVAC FROM VACANCY WHERE ID_VACANCY IN (SELECT ID_VACANCY FROM EMP_CONDITION WHERE EMP_CONDITION_TYPE IN ('Textual', 'Digital', 'Logical', 'MultipleChoice'))
SELECT * FROM EMP_CONDITION E WHERE ID_VACANCY IN (SELECT ID_VACANCY FROM VACANCY WHERE ID_MINISTRY = 1 AND ID_VACANCY = 11) AND EMP_CONDITION_TYPE = 'Logical'
DELETE FROM EMP_CONDITION WHERE ID_EMP_CONDITION = 7
SELECT * FROM EMP_CONDITION
SELECT * FROM VACANCY

SELECT ID_EMP_CONDITION, EMP_CONDITION_NAME, EMP_CONDITION_TYPE FROM EMP_CONDITION WHERE ID_VACANCY IN (SELECT ID_VACANCY FROM VACANCY WHERE ID_VACANCY = 11) AND EMP_CONDITION_TYPE = 'Textual'
SELECT V.ID_VACANCY, VACANCY_NAME || ' (' || VACANCY_TYPE || ': '|| EMP_CONDITION_TYPE ||')' FULLVAC, V.ID_VACANCY||EMP_CONDITION_TYPE FULLID FROM VACANCY V, EMP_CONDITION C  WHERE V.ID_VACANCY = C.ID_VACANCY AND ID_MINISTRY = 1
SELECT * FROM ADMIN