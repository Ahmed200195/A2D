...
CREATE OR REPLACE PACKAGE BODY PAK_MINI_UNVI IS
    ...
    BEGIN
    IF NO = 0 THEN
    SELECT EMPHNO INTO EM FROM EMAILPHONE WHERE ID_M = NUID;
    INSERT INTO DELETENUM(DNUM_M, DNUM_E) VALUES(NUID, EM);
    DELETE FROM MINISTRY WHERE ID_MINISTRY = NUID;
    DELETE FROM EMAILPHONE WHERE ID_M = NUID;
    ELSIF NO = 1 THEN
    SELECT EMPHNO INTO EM FROM EMAILPHONE WHERE ID_U = NUID;
    INSERT INTO DELETENUM(DNUM_U, DNUM_E) VALUES(NUID, EM);
...
SELECT * FROM UNIVERSITY
SELECT * FROM DELETENUM
INSERT INTO DELETENUM(DNUM_U) VALUES(3)