...
<asp:Content ID="ContentVac" ContentPlaceHolderID="SectionMinistry" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel10" runat="server">
        <ContentTemplate>
            ...
            <asp:DropDownList ID="dp_Univ_Vac" runat="server" OnSelectedIndexChanged="dp_Univ_Vac_SelectedIndexChanged"></asp:DropDownList>
            <asp:Label ID="lpExitVac" ForeColor="Red" runat="server" />
            ...
            <asp:DropDownList ID="TypeVac" DataSourceID="XmlDataSource1" DataTextField="text" DataValueField="value" runat="server" OnSelectedIndexChanged="TypeVac_SelectedIndexChanged"></asp:DropDownList>
