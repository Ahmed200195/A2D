...
<asp:Content ID="ContentSection" ContentPlaceHolderID="SectionAdmin" runat="server">
    ...
    <asp:CustomValidator ID="errStartPhe" CssClass="Red" runat="server" OnServerValidate="errStartPhe_ServerValidate" ControlToValidate="txtPhe" ClientValidationFunction="validateStartPhe" ErrorMessage="It must contain the phone number '09 or 011'"></asp:CustomValidator>
    <br />
    ...
    <asp:CustomValidator ID="errGmail" CssClass="Red" runat="server" OnServerValidate="errGmail_ServerValidate" ControlToValidate="txtEmail" ClientValidationFunction="validateGmail" ErrorMessage="must contain @gmail.com only"></asp:CustomValidator>
    <br />
    ...
    <asp:Button ID="brnCrt" runat="server" Text="إنشاء حساب" />
</asp:Content>